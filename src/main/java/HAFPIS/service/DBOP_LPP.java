 ...
 */
public class DBOP_LPP extends Recog implements Runnable {
    private final Logger log = LoggerFactory.getLogger(DBOP_LPP.class);
    int datatype = 0;
                ...
                for (final DbopTaskBean dbopTaskBean : list) {
                    ...
                    Future<String> f = executorService.submit(() -> {
                        try {
                            ...
                            switch (tasktype) {
                                case 6:
                                    if (HbieUtil.getInstance().hbie_LPP != null) {
